...
def run(API, environ, indata, session):
    ...
    emls = session.DB.ES.count(index=session.DB.dbname, doc_type="email", body=query)[
        "count"
    ]
    ...
    for mood in all_moods:
        query["aggs"]["history"]["aggs"][mood] = {"sum": {"field": "mood.%s" % mood}}
    ...
    JSON_OUT = {"timeseries": timeseries, "okay": True}
