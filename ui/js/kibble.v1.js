...
charts_linked = function(obj, nodes, links, options) {
  ...
  svg.call(d3.behavior.zoom().scaleExtent([0.5, 4]).on("zoom", linked_zoom));
  return [
    {
      svg: svg,
      parent: obj,
