...
charts_linked = function(obj, nodes, links, options) {
  var bb, edges, force, link, lla, llcolors, llheight, llwidth, node, svg;
  llcolors = genColors(nodes.length + 1, 0.55, 0.475, true);
  lla = 0;
  svg = d3.select(obj).append("svg").attr("width", "100%").attr("height", "720");
